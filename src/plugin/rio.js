...
const searchRepo = async (m, Matrix) => {
  ...
  if (validCommands.includes(cmd)) {
    const repoUrl = `https://api.github.com/repos/ENZOTECH254/ENZO-MD`;
          ...
          interactiveMessage: proto.Message.InteractiveMessage.create({
            ...
            header: proto.Message.InteractiveMessage.Header.create({
              ...(await prepareWAMessageMedia({
                image: {
                  url: 'https://i.ibb.co/tqhTLN8/IMG-20240916-WA0015.jpg',
                },
              ...
              buttons: [
                {
                  ...
                  buttonParamsJson: JSON.stringify({
                    display_text: 'Chat enzo',
                    url: 'https://wa.me/+254784115308?text=Hi enzo',
                  }),
                },
                {
                  name: 'cta_url',
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: 'https://github.com/ENZOTECH254/ENZO-MD/fork',
                  }),
                },
                {
                  name: 'cta_url',
